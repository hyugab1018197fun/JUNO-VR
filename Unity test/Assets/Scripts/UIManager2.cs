...
{
    [SerializeField] GameObject VRmodeCamera;
    [SerializeField] GameObject WatchmodeCamera;
...
// SetActive (!menuWindow.activeSelf);
    public void Switch_Camera ()
    {
        VRmodeCamera.SetActive(!VRmodeCamera.activeSelf);
        WatchmodeCamera.SetActive(!WatchmodeCamera.activeSelf);

     VRmodeButton.SetActive(!VRmodeButton.activeSelf);
        menuPanel.SetActive(!menuPanel.activeSelf);

    }
    public void BackToMenu()
    {
        VRmodeCamera.SetActive(false);
